 ...
 */
public class CatGroupAdapter extends ArrayAdapter<CatGroup> {

    private final Context context;
    private final ArrayList<CatGroup> itemsArrayList;

    public CatGroupAdapter(Context context, ArrayList<CatGroup> itemsArrayList) {
