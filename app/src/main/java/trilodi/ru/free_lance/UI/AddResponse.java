...
public class AddResponse extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FreeLanceApplication.tracker().send(new HitBuilders.EventBuilder("ui", "open").setLabel("Добавить ответ на проект").build());
                ...
                try {
                    try {
                        ...
                        if (!resp.get("error").toString().equals("0")) {
                            ...
                            FreeLanceApplication.tracker().send(new HitBuilders.EventBuilder("send", "response").setLabel("Отправлен ответ на проект").build());
                        }
