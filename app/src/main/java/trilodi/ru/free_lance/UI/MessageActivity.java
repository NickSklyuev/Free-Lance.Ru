...
import trilodi.ru.free_lance.Adapters.MessageListAdapter;
...
public class MessageActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FreeLanceApplication.tracker().send(new HitBuilders.EventBuilder("ui", "open").setLabel("Переписка").build());
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    try {
                        ...
                        FreeLanceApplication.tracker().send(new HitBuilders.EventBuilder("send", "message").setLabel("Сообщение отправлено").build());
