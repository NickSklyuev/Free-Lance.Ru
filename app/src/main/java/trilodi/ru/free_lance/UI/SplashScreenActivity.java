...
public class SplashScreenActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*FreeLanceApplication.analytics = GoogleAnalytics.getInstance(this);
        FreeLanceApplication.tracker = FreeLanceApplication.analytics.newTracker("UA-58028032-1");
        FreeLanceApplication.tracker.enableExceptionReporting(true);
        FreeLanceApplication.tracker.enableAdvertisingIdCollection(true);
        FreeLanceApplication.tracker.enableAutoActivityTracking(true);*/

        FreeLanceApplication.tracker().send(new HitBuilders.EventBuilder("ui", "open").setLabel("Загрузка").build());
